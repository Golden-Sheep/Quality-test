    ...
    <div class="content">
        <div class="col-xs-12">
            ...
            <div class="card">
                ...
                <form  enctype="multipart/form-data"  action="{{url('pessoas/editar')}}" method="post" autocomplete="off">
                    <div class="card-body">
                        {!! csrf_field() !!}
                        ...
                        <div class="col-xs-12">
                            <div class="form-group ">
                                ...
                                <input type="text" name="nome"
                                       class="form-control {{$errors->has('nome') ? 'is-invalid' : '' }}" value="{{$pessoa->nome}}" required>
                                @if($errors->has('nome'))
                        ...
                        <div class="col-xs-12">
                            <div class="form-group ">
                                ...
                                <input type="date" min="{{date_format(date_create("-120 years"), 'Y-m-d')}}" max="{{date('Y-m-d')}}"
                                       ...
                                       value="{{date_format(date_create($pessoa->data_de_nascimento), 'Y-m-d')}}"
                                       required>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group ">
                                ...
                                <input type="email" name="email"
                                       class="form-control {{$errors->has('email') ? 'is-invalid' : '' }}" value="{{$pessoa->email}}" required>
                                @if($errors->has('email'))
                                    <span class="help-block text-red">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-flat btn-primary float-right">Salvar Alterações</button>
                    </div>
                </form>
            </div>
        </div>
